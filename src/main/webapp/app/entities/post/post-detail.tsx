    ...
    <Row>
      <Col md="8">
        <h2 data-cy="postDetailsHeading">
          <Translate contentKey="jHReactDemoApp.post.detail.title">Post</Translate>
        </h2>
        <dl className="jh-entity-details">
          ...
          <dt>
            <span id="title">
              <Translate contentKey="jHReactDemoApp.post.title">Title</Translate>
            </span>
          </dt>
          <dd>{postEntity.title}</dd>
          <dt>
            <span id="body">
              <Translate contentKey="jHReactDemoApp.post.body">Body</Translate>
            </span>
          </dt>
