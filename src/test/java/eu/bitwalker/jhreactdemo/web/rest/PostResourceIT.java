package eu.bitwalker.jhreactdemo.web.rest;
...
import eu.bitwalker.jhreactdemo.repository.PostRepository;
...
class PostResourceIT {
    ...
    public static Post createEntity(EntityManager em) {
        Post post = new Post().title(DEFAULT_TITLE).body(DEFAULT_BODY);
        return post;
    }
    ...
    public static Post createUpdatedEntity(EntityManager em) {
        Post post = new Post().title(UPDATED_TITLE).body(UPDATED_BODY);
        return post;
    }
    ...
    void putNewPost() throws Exception {
        ...
        updatedPost.title(UPDATED_TITLE).body(UPDATED_BODY);
    ...
    void partialUpdatePostWithPatch() throws Exception {
        ...
        partialUpdatedPost.body(UPDATED_BODY);
    ...
    void fullUpdatePostWithPatch() throws Exception {
        ...
        partialUpdatedPost.title(UPDATED_TITLE).body(UPDATED_BODY);
